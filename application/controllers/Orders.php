...
class Orders extends Admin_Controller
{
	...
	*/
	public function index()
	{
		...
		$this->data['page_title'] = 'Administrar Ordenes';
	...
	*/
	public function create()
	{
		...
		$this->form_validation->set_rules('product[]', 'Nombre Producto', 'trim|required');
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($order_id) {
        		$this->session->set_flashdata('Exito', 'Creado satisfactoriamente');
	...
	*/
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($update == true) {
        		$this->session->set_flashdata('Exito', 'Actualizado satisfactoriamente');
        	...
        	if(empty($orders_data)) {
        		$this->session->set_flashdata('errors', 'No existen datos');
	...
	public function remove()
	{
        ...
        if($order_id) {
            ...
            if($delete == true) {
                ...
                $response['messages'] = "Eliminado";
            }
            else {
                $response['success'] = false;
                $response['messages'] = "Error en la base al eliminar producto";
            }
        }
        else {
            $response['success'] = false;
            $response['messages'] = "refresque de nuevo la pagina";
        }
			  ...
			  <section class="invoice">
			    ...
			    <div class="row invoice-info">
			      ...
			      <div class="col-sm-4 invoice-col">
			        ...
			        <b>Nombre Meza: </b> '.$table_data['table_name'].'<br>
			        <b>Total ordenes: </b> '.count($orders_items).'<br><br>
			      </div>
			      <!-- /.col -->
			    </div>
			    <!-- /.row -->
			        ...
			        <div class="table-responsive">
			          <table class="table">
			            ...
			            if($order_data['service_charge_amount'] > 0) {
			            	$html .= '<tr>
				              <th>Cargo Servicio ('.$order_data['service_charge_rate'].'%)</th>
			            ...
			            if($order_data['vat_charge_amount'] > 0) {
			            	$html .= '<tr>
				              <th>Cargo Impuesto ('.$order_data['vat_charge_rate'].'%)</th>
