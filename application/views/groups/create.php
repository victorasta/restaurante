            ...
            <form role="form" action="<?php base_url('groups/create') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="group_name">Nombre Grupo</label>
                  <input type="text" class="form-control" id="group_name" name="group_name" placeholder="Ingrese nombre de grupo" required autocomplete="off">
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('groups/') ?>" class="btn btn-warning">Atras</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
