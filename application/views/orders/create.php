        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-12 control-label">Hora: <?php date_default_timezone_set('America/El_Salvador'); echo  date('h:i a') ?></label>
                </div>

                <div class="col-md-4 col-xs-12 pull pull-left">

                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Meza</label>
                    <div class="col-sm-7">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label">Monto Bruto</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label">Cargo_servicio <?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="vat_charge" class="col-sm-5 control-label">Impuesto <?php echo $company_data['vat_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Monto Neto</label>
                    <div class="col-sm-7">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('orders/') ?>" class="btn btn-warning">Atrás</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
