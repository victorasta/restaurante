        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="time" class="col-sm-12 control-label">Hora: <?php  date_default_timezone_set('America/El_Salvador'); echo date('h:i a'); ?></label>
                </div>
...
<script type="text/javascript">
  ...
  function getTotal(row = null) {
    if(row) {
      ...
      alert('Ninguna columna, refresque la página');
    }
  }
