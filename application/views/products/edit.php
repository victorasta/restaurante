          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name"  required placeholder="Ingrese el nombre del producto" autocomplete="off" value="<?php echo !empty($this->input->post('product_name')) ?:$product_data['name'] ?>" />
                </div>

                <div class="form-group">
                  <label for="price">Precio</label>
                  <input type="text" class="form-control" id="price" name="price" required placeholder="Ingrese Precio" autocomplete="off" value="<?php echo !empty($this->input->post('price')) ?:$product_data['price'] ?>"/>
                </div>

                <div class="form-group">
                  <label for="description">Descripción</label>
                  <textarea type="text" class="form-control" id="description" required name="description" placeholder="Ingrese Descripción" autocomplete="off">
