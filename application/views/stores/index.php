      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createStore', $user_permission)): ?>
            <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Agregar Franquicia</button>
            <br /> <br />
          <?php endif; ?>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Administrar Franquicia</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
      ...
      <form role="form" action="<?php echo base_url('stores/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Nombre Tienda</label>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('stores/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Nombre Tienda</label>
            <input type="text" class="form-control" id="edit_store_name" name="edit_store_name" placeholder="Ingrese Nombre" autocomplete="off">
          </div>
